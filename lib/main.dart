    ...
    return MaterialApp(
        ...
        theme: ThemeData(
          ...
          colorScheme: ColorScheme.fromSeed(
              seedColor: Color.fromARGB(255, 98, 197, 167)),
        ),
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String someText = "";
  String tattooFilePath = "assets/images/tatoo-1.png";
  int posX = 350;
  int posY = 700;
  int angle = 0;
  ...
  void applyTatoo() async {
    final tatooFile = await rootBundle.load(tattooFilePath);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text('Татуювання')),
        body: Container(
            ...
            child: Row(children: [
              Column(children: [
                ...
                Row(children: [
                  IconButton(
                    icon: Image.asset("assets/images/tatoo-1.png", width: 60),
                    iconSize: 20,
                    onPressed: () {
                      tattooFilePath = "assets/images/tatoo-1.png";
                      applyTatoo();
                    },
                  ),
                  IconButton(
                    icon: Image.asset("assets/images/tatoo-2.png", width: 60),
                    iconSize: 20,
                    onPressed: () {
                      tattooFilePath = "assets/images/tatoo-2.png";
                      applyTatoo();
                    },
                  ),
                  IconButton(
                    icon: Image.asset("assets/images/tatoo-3.png", width: 60),
                    iconSize: 50,
                    onPressed: () {
                      tattooFilePath = "assets/images/tatoo-3.png";
                      applyTatoo();
                    },
                  ),
                  IconButton(
                    icon: Image.asset("assets/images/tatoo-4.png", width: 60),
                    iconSize: 50,
                    onPressed: () {
                      tattooFilePath = "assets/images/tatoo-4.png";
                      applyTatoo();
                    },
                  )
                ]),
